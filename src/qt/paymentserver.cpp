...
const QString BITCOIN_IPC_PREFIX("SNKCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click SNKCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start SNKCoin: click-to-pay handler");
    else
...
{
    // clicking on SNKCoin: URLs creates FileOpen events on the Mac:
