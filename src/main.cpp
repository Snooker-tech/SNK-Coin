...
// Copyright (c) 2017 The SNKCoin Developers
...
uint256 hashGenesisBlock("00000ceda9239c83209b73283903619b235a7507f869e6a59bd06b01c0130987");//，替换2.0
static const unsigned int timeGenesisBlock = 1505447918;//1456048686;//替换1.0
...
const string strMessageMagic = "SNKCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
       const char* pszTimestamp = "already in already databases we SNKCoin from USA with Transactions.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 449674;//替换1.2，替换2.2
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("bef44a5cdec1f0c8452a2443304f366beab00af77f0ddb557c9162da0cd40bd4"));//替换2.1
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SNKCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SNKCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("SNKCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("SNKCoin-miner");
    ...
    try { loop {
        ...
        printf("Running SNKCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("SNKCoinMiner terminated\n");
        throw;
    }
}
